...
for (let i = 0; i < draggableElements.length; i++) {
  ...
  draggableElements[i].addEventListener('click', (e) =>{
    if(e.code == 'Minus') {
        if(parseInt(draggableElements[i].style.height) > 20 && parseInt(draggableElements[i].style.width) > 10)
        {
            draggableElements[i].style.height = (parseInt(draggableElements[i].style.height)-10) + 'px';
            draggableElements[i].style.width = (parseInt(draggableElements[i].style.width)-10) + 'px';
        }
    }
    if(e.code == 'Equal' && e.ShiftKey){
        if(parseInt(draggableElements[i].style.height) < 410 && parseInt(draggableElements[i].style.width) < 370){
            draggableElements[i].style.height = (parseInt(draggableElements[i].style.height)+10) + 'px';
            draggableElements[i].style.width = (parseInt(draggableElements[i].style.width)+10) + 'px';
        }
    }
